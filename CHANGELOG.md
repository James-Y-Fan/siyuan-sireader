...
---
0.8.91
1.尝试修复Linux设备上TTS无法加载的问题
2.增加翻译功能，支持Azure、Google、Yandex三种方式（Azure、Google可能不生效）
3.修复本地文件生成跳转链接的复制限制
4.修复了目录重复显示标签图标的问题
5.优化了弹窗在阅读界面的定位，不会超出阅读界面并与边缘留出合适的间距
6.增加了阅读工具栏透明度调节功能0-100%
7.增加了快速标注功能，点击阅读下方工具栏选中颜色和样式后选中文字即可标注
8.增加了撤回标注功能，ctrl加z即可撤回标注
